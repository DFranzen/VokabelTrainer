 ...
 *  - Added sort icons
 *  - Proper reload of file on click
 *  - BUG: search message showing on empty list
 *  - improved Blättern buttons in deatils dialog
 */
...
app = {
    ...
    activateRevision: function () {
        ...
        window.setTimeout(function () { trainingView.hideUndo(); }, 3);
    },
